      ...
      <?php include "includes/nav.html"; ?>
        <div class="col-7-12">
          <div class="grid-pad content">
            ...
            <p>In addition to the fine selection of beers (16 on draft!), select wines on tap, and excellent cocktails, Cary's features free pool on our 9 foot Diamond table, free play on our Killer Queen video game, and a badass selection on the jukebox. And you can enjoy your drink on our wonderful outdoor patio!</p>
          </div>
        </div>  
        <div class="col-5-12">
          <div class="content">
